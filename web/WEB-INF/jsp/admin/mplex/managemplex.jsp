...
<%--                    </tr>--%>
            ...
            <form action="/admin/mplex/managemplex" method="post">
                ...
                <label for="naziv">Naziv multiplexa:</label>
                <td><input class="form-control" id="naziv" name="naziv" type="text"></td>
                <td><input type="submit" class="btn btn-primary mt-3" value="Dodaj"></td>
            </form>
        </div>
    </div>
</div>
