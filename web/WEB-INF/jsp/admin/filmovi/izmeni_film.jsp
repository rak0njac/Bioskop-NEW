...
<div class="container">
    <div class="row  bg-light p-3">
        <div class="col">
            <h3>Izmena filma - odaberite film iz liste</h3>
            <table class="table">
                <thead>
                <tr>
                    <th>Naziv</th>
                ...
                <tbody>
                    <c:forEach items="${requestScope.filmovi}" var="m">
                        <tr>
                            <form action="/admin/filmovi/izmeni_film" method="get">
                                ...
                                <td>${m.godina}</td>
                                <td>${m.trajanje}</td>
                                <td><input type="submit" class="btn btn-primary btn-izmena" value="Izmeni"></td>
                            </form>
                        </tr>
                    </c:forEach>
                </tbody>
