...
//    }
    ...
    public static ArrayList<Karta> findByFilmMplex(Film film, Multiplex mplex) throws SQLException {
        int idFilm = film.getIdFilm();
        int idMplex = mplex.getIdMultiplex();
    ...
    public static Karta findByProjAndSeat(Projekcija projekcija, Sediste sediste) throws SQLException {
        int idProjekcija = projekcija.getIdProjekcija();
        String tipSedista = sediste.getTip();
    ...
    public static void reserveTicket(Karta karta, String username) throws SQLException {
...
//        else return "NEMA KARATA";
    ...
    public static int insert(Projekcija projekcija, String tipSedista, Double cena) throws SQLException {
        ...
        while(rs.next())
        {
            ...
            {
                ps = con.prepareStatement("insert into karta(idprojekcija, idsediste, cena) values (?,?,?)", ps.RETURN_GENERATED_KEYS);
